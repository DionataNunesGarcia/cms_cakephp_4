...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $systemParameter->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $systemParameter->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="systemParameters form content">
            ...
            <fieldset>
                <legend><?= __('Edit System Parameter') ?></legend>
                <?php
