...
use App\Services\Datatables\EventsTypesDatatablesService;
use App\Services\Form\EventsTypesFormService;
 ...
 */
class EventsTypesController extends AdminController
{
    /**
     * @var EventsTypesFormService $_formService
     */
    private EventsTypesFormService $_formService;

    /**
     * @var EventsTypesManagerService $_managerService
     */
    private EventsTypesManagerService $_managerService;

    /**
     * @var EventsTypesDatatablesService
     */
    private EventsTypesDatatablesService $_datatableService;
